package com.example.lenovo.basepopuwindow.Base;
...
public class BasePopupHelper implements PopupWindow.OnDismissListener {
    /**
     * PopupWindow放在view左边
     */
    ...
    private BasePopupHelper(Builder builder) {
    ...
    public static class Builder {
        ...
        public BasePopupHelper build() {
            ...
            return new BasePopupHelper(this);
        }

    }

    public interface ViewInterface {
        void onViewClick(View view, int layoutResId);
